...
const AboutMe = () => {
  ...
  return (
      ...
      <AnimationOnScroll
        ...
        <div ref={container} id='about' className='p-16 space-y-5' smooth>
          ...
          <div className='w-full gap-16 py-5 text-[#201A1A]'>
            ...
            <AnimationOnScroll 
              ...
              <motion.div 
                ...
                <motion.h3 className='md:text-7xl font-banery text-black/50'>Nickname: Dwight <span className='text-sm'>(The office)</span></motion.h3>
                <motion.div className='text-start flex w-full items-center py-3 space-x-5 font-banery'>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>D</span>etermined</h4>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>W</span>orker</h4>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>I</span>ntense</h4>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>G</span>ood Worker</h4>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>H</span>ard Worker</h4>
                  <h4 className='items-center'><span className='md:text-5xl font-bold text-green'>T</span>errific</h4>
                </motion.div>
              </motion.div> 
              <motion.div
                initial={{y: 200}}
                ...
                className='w-full col-span-4'>
                  <div className='text-justify grid grid-cols-5 bg-green text-white rounded-br-full py-16 pl-24 pr-24 space-y-5'> 
                    <div className='flex'>
                    ...
                    <div className='col-span-4 grid grid-cols-6  text-center text-light text-gray-600 pr-16'>
                      <div className='border-[#AB9C81] border-r-2 col-span-2 space-y-4'> 
                      ...
                      <div className='border-[#AB9C81] col-span-2 border-r-2 px-5 space-y-4'> 
                  ...
                  <AnimationOnScroll animateIn="animate__fadeIn">
                    <div className='text-justify font-bold py-32 space-y-10'> 
                      <motion.h3 
                        ...
                        className='font-banery font-normal text-8xl text-start text-green'
                      >Creating Interactive and Engaging Digital Experiences using</motion.h3> 
                      <motion.div
                        initial={{y: 120}} 
                        animate={{y: 0}}
                        transition={{duration:1, delay: 2}}
                        className='w-full grid grid-cols-7 gap-10 md:flex justify-between space-x-10 my-5'>
                        {/* Html */}
                        ...
                        {/* Illustrator */}
                        <svg className='w-10' viewBox="0 0 128 128">
                        ...
                        {/* nextjs */}
                        <SiNextdotjs className='w-16 h-16 bg-[#E7DFCF] rounded-md p-2'/>
                        {/* p5.js */}
                        {/* <svg className='w-16 bg-[#E7DFCF] rounded-md p-2'   viewBox="0 0 128 128">
