      ...
      <div className='p-16' id='works'>
        ...
        <div className=''>
          ...
          <div className='grid grid-cols-5'>
            <p className=' text-[0.9em] col-span-3'>These are the personal projects I did by my own and asked by others. The apps are built using the technologies i mentioned in my experties.You can view my projects in detail on my github link.</p>
          ...
          <div className='grid grid-cols-5 gap-5 max-h-[70%] relative my-10 rounded-md'>
